...
ALLOWED_HOSTS = ['boutique-ado-vladimir-93960e4973be.herokuapp.com', 'localhost', '8000-vladaalek-boutiquecodei-0lwkbxsfsdh.ws-eu116.gitpod.io']
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutique-ado-vladimir'
